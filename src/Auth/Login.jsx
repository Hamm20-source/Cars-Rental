      ...
      <div className='relative flex flex-col justify-center items-center h-screen space-y-10'>
        ...
        <form onSubmit={handleLogin} className='w-80 flex flex-col'>
          ...
          <input 
            ...
            id='email'
            placeholder="Email"
            className='mb-5 p-2 shadow-xs border border-gray-300 rounded-md outline-none'
            value={email}
          ...
          <div className='relative'>
            <input 
              ...
              className='w-80 mb-5 p-2 shadow-xs border border-gray-300 rounded-md outline-none'
              value={password}
              onChange={(e) => setPassword(e.target.value)}
              required 
            />
            <div className='absolute right-2 bottom-1/2 cursor-pointer'>
              {showPassword
